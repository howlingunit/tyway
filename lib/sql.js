...
export async function getUpdates() {
  ...
  return db.all('SELECT description, type, date, services.service, services.link FROM updates join services on updates.service == services.id ORDER BY updates.date DESC');
}
