...
INSERT INTO apps(id, name, Link, gitLink, lastUpdated, status) VALUES
  ...
  (2, 'Star wars weather', 'http://sww.tyway.net', 'https://github.com/howlingunit/star-wars-weather', '2022-09-26', 2),
  ...
  (7, 'Stefs massage', 'http://stefsmassage.co.uk', 'https://github.com/howlingunit/stefs-massage-website', '2022-09-27', 1),
